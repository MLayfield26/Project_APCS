...
public class Scene19A implements Scene{

   private PImage dicedTofu;
  private PApplet p;
   private PImage Display19A, pan;

        private int current;
    public Scene19A(PApplet p){
      dicedTofu = p.loadImage("dicedTofu.png");
Display19A = p.loadImage("Display19A.png");
...
pan = p.loadImage("pan.png");
    ...
    public void display(){
      ...
      p.image(Display19A,0,0,1400,800);
