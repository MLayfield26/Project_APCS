...
public class Scene18A implements Scene{

   private PImage dicedTofu;
  private PApplet p;
   private PImage Display18A, pan;
   private PImage D3Ba;
        private int current;
    public Scene18A(PApplet p){
      dicedTofu = p.loadImage("dicedTofu.png");
Display18A = p.loadImage("Display18A.png");
...
pan = p.loadImage("pan.png");
    ...
    public void display(){
      ...
      p.image(Display18A,0,0,1400,800);
